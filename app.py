...
def generate_date_range(start_date, end_date, num_entries, orientation, days_option, include_holidays, holidays):
    ...
    # Filtra por días de semana o fines de semana si es necesario
    ...
    if holidays:
        ...
        if include_holidays:
            # Unir los festivos con las fechas, asegurando que los festivos estén dentro del rango
            dates = dates.union(holidays_in_range).sort_values()
